...
import { UserWorkStats } from "@/components/analytics/user-work-stats";
...
export const getAnalyticsTabs = (t: (key: string, params?: Record<string, any>) => string): AnalyticsTab[] => [
  ...
  { key: "user-work-stats", label: t("analytics.user_work_stats.title"), content: UserWorkStats, isDisabled: false },
];
