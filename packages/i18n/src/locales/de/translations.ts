export default {
  ...
  analytics: {
    user_work_stats: {
      title: "Benutzerarbeitsstatistiken",
      description: "Zeigen Sie umfassende Statistiken und Einblicke zur Arbeitsleistung einzelner Teammitglieder an.",
      overview: {
        total_assigned: "Gesamt zugewiesen",
        total_assigned_description: "Gesamtzahl der Teammitgliedern zugewiesenen Arbeitselemente",
        total_completed: "Gesamt abgeschlossen",
        total_completed_description: "Gesamtzahl der von Teammitgliedern abgeschlossenen Arbeitselemente",
        completion_rate: "Abschlussrate",
        completion_rate_description: "Prozentsatz der zugewiesenen Arbeitselemente, die abgeschlossen wurden",
        avg_completion_time: "Durchschnittliche Abschlusszeit",
        avg_completion_time_description: "Durchschnittliche Zeit zum Abschließen von Arbeitselementen (in Tagen)",
        overdue_count: "Überfällig",
        overdue_count_description: "Anzahl der Arbeitselemente, die ihr Zieltermin überschritten haben",
      },
      distribution: {
        by_state: "Verteilung nach Status",
        by_priority: "Verteilung nach Priorität",
        no_data: "Keine Verteilungsdaten verfügbar",
      },
      activity_trends: {
        title: "Aktivitätstrends",
        created: "Erstellt",
        completed: "Abgeschlossen",
        no_data_title: "Keine Aktivitätsdaten verfügbar",
        no_data_subtitle: "Im Laufe der Zeit erstellte und abgeschlossene Arbeitselemente werden hier angezeigt",
      },
      efficiency: {
        title: "Mitgliedereffizienz",
        user: "Benutzer",
        total_issues: "Gesamte Elemente",
        completed: "Abgeschlossen",
        completion_rate: "Abschlussrate",
        avg_completion_time: "Durchschnittszeit",
        pending: "Ausstehend",
        overdue: "Überfällig",
      },
      error: {
        title: "Fehler beim Laden der Statistiken",
        description: "Beim Laden der Benutzerarbeitsstatistiken ist ein Fehler aufgetreten. Bitte versuchen Sie es später erneut.",
      },
      no_data: "Keine Daten verfügbar",
      workspace_required: {
        title: "Arbeitsbereich erforderlich",
        description: "Bitte geben Sie einen Arbeitsbereichs-Slug an. Sie können auf diese Seite von einer Arbeitsbereichs-Analyse-Seite zugreifen oder ?workspace_slug=your-workspace-slug zur URL hinzufügen.",
      },
    },
    common: {
      count: "Anzahl",
