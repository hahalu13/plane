export default {
  ...
  analytics: {
    user_work_stats: {
      title: "User Work Statistics",
      description: "View comprehensive statistics and insights about individual team members' work performance.",
      overview: {
        total_assigned: "Total Assigned",
        total_assigned_description: "Total number of work items assigned to team members",
        total_completed: "Total Completed",
        total_completed_description: "Total number of work items completed by team members",
        completion_rate: "Completion Rate",
        completion_rate_description: "Percentage of assigned work items that have been completed",
        avg_completion_time: "Avg Completion Time",
        avg_completion_time_description: "Average time taken to complete work items (in days)",
        overdue_count: "Overdue",
        overdue_count_description: "Number of work items that are past their target date",
      },
      distribution: {
        by_state: "Distribution by State",
      ...
      activity_trends: {
        ...
        created: "Created",
        completed: "Completed",
        no_data_title: "No activity data available",
        no_data_subtitle: "Work items created and completed over time will appear here",
      },
      efficiency: {
      ...
      gantt: {
        title: "Member Task Gantt Chart",
        no_data: "No tasks with dates available for display",
        no_data_description: "Tasks assigned to members with dates will appear here",
      },
      time_gantt: {
        title: "Time-based Task Gantt Chart",
        no_data: "No tasks with dates available for display",
        no_data_description: "Tasks organized by time dimension will appear here",
      ...
      error: {
        ...
        description: "There was an error loading user work statistics. Please try again later.",
      },
      no_data: "No data available",
      workspace_required: {
        title: "Workspace Required",
        description: "Please provide a workspace slug. You can access this page from a workspace analytics page or add ?workspace_slug=your-workspace-slug to the URL.",
      },
    },
    date_range: {
      start_date: "Start date",
