export default {
  ...
  analytics: {
    user_work_stats: {
      title: "Estadísticas de trabajo de usuarios",
      description: "Vea estadísticas e información completa sobre el rendimiento laboral de los miembros individuales del equipo.",
      overview: {
        total_assigned: "Total asignado",
        total_assigned_description: "Número total de elementos de trabajo asignados a los miembros del equipo",
        total_completed: "Total completado",
        total_completed_description: "Número total de elementos de trabajo completados por los miembros del equipo",
        completion_rate: "Tasa de finalización",
        completion_rate_description: "Porcentaje de elementos de trabajo asignados que se han completado",
        avg_completion_time: "Tiempo promedio de finalización",
        avg_completion_time_description: "Tiempo promedio necesario para completar elementos de trabajo (en días)",
        overdue_count: "Atrasado",
        overdue_count_description: "Número de elementos de trabajo que han pasado su fecha objetivo",
      },
      distribution: {
        by_state: "Distribución por estado",
        by_priority: "Distribución por prioridad",
        no_data: "No hay datos de distribución disponibles",
      },
      activity_trends: {
        title: "Tendencias de actividad",
        created: "Creados",
        completed: "Completados",
        no_data_title: "No hay datos de actividad disponibles",
        no_data_subtitle: "Los elementos de trabajo creados y completados a lo largo del tiempo aparecerán aquí",
      },
      efficiency: {
        title: "Eficiencia de miembros",
        user: "Usuario",
        total_issues: "Total de elementos",
        completed: "Completados",
        completion_rate: "Tasa de finalización",
        avg_completion_time: "Tiempo promedio",
        pending: "Pendiente",
        overdue: "Atrasado",
      },
      error: {
        title: "Error al cargar estadísticas",
        description: "Hubo un error al cargar las estadísticas de trabajo de usuarios. Por favor, inténtelo de nuevo más tarde.",
      },
      no_data: "No hay datos disponibles",
      workspace_required: {
        title: "Espacio de trabajo requerido",
        description: "Por favor, proporcione un identificador de espacio de trabajo. Puede acceder a esta página desde una página de análisis del espacio de trabajo o agregar ?workspace_slug=your-workspace-slug a la URL.",
      },
    },
    common: {
      count: "Cantidad",
