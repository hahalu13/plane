export default {
  ...
  analytics: {
    user_work_stats: {
      title: "Statistiques de travail des utilisateurs",
      description: "Affichez des statistiques et des informations complètes sur les performances de travail des membres individuels de l'équipe.",
      overview: {
        total_assigned: "Total assigné",
        total_assigned_description: "Nombre total d'éléments de travail assignés aux membres de l'équipe",
        total_completed: "Total complété",
        total_completed_description: "Nombre total d'éléments de travail complétés par les membres de l'équipe",
        completion_rate: "Taux de complétion",
        completion_rate_description: "Pourcentage d'éléments de travail assignés qui ont été complétés",
        avg_completion_time: "Temps moyen de complétion",
        avg_completion_time_description: "Temps moyen nécessaire pour compléter les éléments de travail (en jours)",
        overdue_count: "En retard",
        overdue_count_description: "Nombre d'éléments de travail dépassant leur date cible",
      },
      distribution: {
        by_state: "Distribution par état",
        by_priority: "Distribution par priorité",
        no_data: "Aucune donnée de distribution disponible",
      },
      activity_trends: {
        title: "Tendances d'activité",
        created: "Créés",
        completed: "Complétés",
        no_data_title: "Aucune donnée d'activité disponible",
        no_data_subtitle: "Les éléments de travail créés et complétés au fil du temps apparaîtront ici",
      },
      efficiency: {
        title: "Efficacité des membres",
        user: "Utilisateur",
        total_issues: "Total des éléments",
        completed: "Complétés",
        completion_rate: "Taux de complétion",
        avg_completion_time: "Temps moyen",
        pending: "En attente",
        overdue: "En retard",
      },
      error: {
        title: "Erreur lors du chargement des statistiques",
        description: "Une erreur s'est produite lors du chargement des statistiques de travail des utilisateurs. Veuillez réessayer plus tard.",
      },
      no_data: "Aucune donnée disponible",
      workspace_required: {
        title: "Espace de travail requis",
        description: "Veuillez fournir un identifiant d'espace de travail. Vous pouvez accéder à cette page depuis une page d'analyse d'espace de travail ou ajouter ?workspace_slug=your-workspace-slug à l'URL.",
      },
    },
    common: {
      count: "Nombre",
