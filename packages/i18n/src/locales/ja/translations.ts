export default {
  ...
  analytics: {
    user_work_stats: {
      title: "ユーザー作業統計",
      description: "チームメンバーの作業パフォーマンスに関する包括的な統計と洞察を表示します。",
      overview: {
        total_assigned: "総割り当て数",
        total_assigned_description: "チームメンバーに割り当てられた作業項目の総数",
        total_completed: "総完了数",
        total_completed_description: "チームメンバーが完了した作業項目の総数",
        completion_rate: "完了率",
        completion_rate_description: "完了した作業項目の割り当て作業項目に対する割合",
        avg_completion_time: "平均完了時間",
        avg_completion_time_description: "作業項目を完了するのに必要な平均時間（日数）",
        overdue_count: "期限超過",
        overdue_count_description: "目標日を過ぎた作業項目の数",
      },
      distribution: {
        by_state: "状態別分布",
        by_priority: "優先度別分布",
      ...
      activity_trends: {
        ...
        created: "作成済み",
        completed: "完了済み",
        no_data_title: "アクティビティデータがありません",
        no_data_subtitle: "時間の経過とともに作成および完了された作業項目がここに表示されます",
      },
      efficiency: {
        title: "メンバー効率",
        user: "ユーザー",
        ...
        completed: "完了",
        completion_rate: "完了率",
        avg_completion_time: "平均時間",
        pending: "保留中",
        overdue: "期限超過",
      },
      error: {
        title: "統計情報の読み込みエラー",
        description: "ユーザー作業統計情報の読み込み中にエラーが発生しました。後でもう一度お試しください。",
      },
      no_data: "データがありません",
      workspace_required: {
        title: "ワークスペースが必要です",
        description: "ワークスペーススラッグを提供してください。ワークスペース分析ページからこのページにアクセスするか、URL に ?workspace_slug=your-workspace-slug を追加してください。",
      },
    },
    common: {
      count: "カウント",
