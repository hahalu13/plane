export default {
  ...
  analytics: {
    user_work_stats: {
      title: "사용자 작업 통계",
      description: "개별 팀원의 작업 성과에 대한 포괄적인 통계 및 인사이트를 확인합니다.",
      overview: {
        total_assigned: "총 할당 수",
        total_assigned_description: "팀원에게 할당된 작업 항목의 총 수",
        total_completed: "총 완료 수",
        total_completed_description: "팀원이 완료한 작업 항목의 총 수",
        completion_rate: "완료율",
        completion_rate_description: "완료된 작업 항목이 할당된 작업 항목에서 차지하는 비율",
        avg_completion_time: "평균 완료 시간",
        avg_completion_time_description: "작업 항목을 완료하는 데 필요한 평균 시간(일)",
        overdue_count: "연체",
        overdue_count_description: "목표 날짜를 지난 작업 항목 수",
      },
      distribution: {
        by_state: "상태별 분포",
      ...
      activity_trends: {
        ...
        created: "생성됨",
        completed: "완료됨",
        no_data_title: "활동 데이터 없음",
        no_data_subtitle: "시간에 따라 생성되고 완료된 작업 항목이 여기에 표시됩니다",
      },
      efficiency: {
        title: "멤버 효율성",
        user: "사용자",
        total_issues: "총 작업 항목",
        completed: "완료",
        completion_rate: "완료율",
        avg_completion_time: "평균 시간",
        pending: "대기 중",
        overdue: "연체",
      },
      error: {
        title: "통계 로드 오류",
        description: "사용자 작업 통계를 로드하는 중 오류가 발생했습니다. 나중에 다시 시도해 주세요.",
      },
      no_data: "데이터 없음",
      workspace_required: {
        title: "작업 공간 필요",
        description: "작업 공간 슬러그를 제공해 주세요. 작업 공간 분석 페이지에서 이 페이지에 액세스하거나 URL에 ?workspace_slug=your-workspace-slug를 추가할 수 있습니다.",
      },
    },
    common: {
      count: "개수",
