export default {
  ...
  analytics: {
    user_work_stats: {
      title: "Статистика работы пользователей",
      description: "Просматривайте полную статистику и аналитику производительности отдельных членов команды.",
      overview: {
        total_assigned: "Всего назначено",
        total_assigned_description: "Общее количество рабочих элементов, назначенных членам команды",
        total_completed: "Всего завершено",
        total_completed_description: "Общее количество рабочих элементов, завершённых членами команды",
        completion_rate: "Процент завершения",
        completion_rate_description: "Процент назначенных рабочих элементов, которые были завершены",
        avg_completion_time: "Среднее время завершения",
        avg_completion_time_description: "Среднее время, необходимое для завершения рабочих элементов (в днях)",
        overdue_count: "Просрочено",
        overdue_count_description: "Количество рабочих элементов, которые превысили целевую дату",
      },
      distribution: {
        by_state: "Распределение по статусу",
        by_priority: "Распределение по приоритету",
        no_data: "Нет данных о распределении",
      },
      activity_trends: {
        title: "Тенденции активности",
        created: "Создано",
        completed: "Завершено",
        no_data_title: "Нет данных об активности",
        no_data_subtitle: "Рабочие элементы, созданные и завершённые со временем, появятся здесь",
      },
      efficiency: {
        title: "Эффективность членов",
        user: "Пользователь",
        total_issues: "Всего элементов",
        completed: "Завершено",
        completion_rate: "Процент завершения",
        avg_completion_time: "Среднее время",
        pending: "В ожидании",
        overdue: "Просрочено",
      },
      error: {
        title: "Ошибка загрузки статистики",
        description: "Произошла ошибка при загрузке статистики работы пользователей. Пожалуйста, попробуйте позже.",
      },
      no_data: "Нет данных",
      workspace_required: {
        title: "Требуется рабочее пространство",
        description: "Пожалуйста, укажите идентификатор рабочего пространства. Вы можете получить доступ к этой странице со страницы аналитики рабочего пространства или добавить ?workspace_slug=your-workspace-slug к URL.",
      },
    },
    common: {
      count: "Количество",
