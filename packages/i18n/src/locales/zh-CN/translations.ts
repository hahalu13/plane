export default {
  sidebar: {
    ...
    display_mode: {
      icon_only: "仅图标",
      icon_with_name: "图标和名称",
    },
    dock_app_rail: "停靠应用栏",
    undock_app_rail: "取消停靠应用栏",
  },
  auth: {
    common: {
      email: {
  ...
  analytics: {
    user_work_stats: {
      title: "人员工作统计",
      description: "查看团队成员工作表现的全面统计和洞察。",
      overview: {
        total_assigned: "总分配数",
        total_assigned_description: "分配给团队成员的工作项总数",
        total_completed: "总完成数",
        total_completed_description: "团队成员完成的工作项总数",
        completion_rate: "完成率",
        completion_rate_description: "已完成的工作项占分配工作项的百分比",
        avg_completion_time: "平均完成时间",
        avg_completion_time_description: "完成工作项所需的平均时间（天数）",
        overdue_count: "逾期",
        overdue_count_description: "超过目标日期的工作项数量",
      },
      distribution: {
        by_state: "按状态分布",
        by_priority: "按优先级分布",
      ...
      activity_trends: {
        ...
        created: "已创建",
        completed: "已完成",
        no_data_title: "暂无活动数据",
        no_data_subtitle: "随时间创建和完成的工作项将显示在这里",
      },
      efficiency: {
        title: "成员效率",
        user: "用户",
      ...
      gantt: {
        title: "成员任务甘特图",
        no_data: "暂无带日期的任务可显示",
        no_data_description: "分配给成员且带有日期的任务将显示在这里",
      },
      time_gantt: {
        title: "会员维度任务甘特图",
        no_data: "暂无带日期的任务可显示",
        no_data_description: "按时间维度组织的任务将显示在这里",
        included_tasks: "包含的任务",
      },
      date_range: {
        start_date: "开始日期",
        end_date: "结束日期",
      ...
      error: {
        title: "加载统计信息时出错",
        description: "加载人员工作统计信息时出错。请稍后重试。",
      },
      no_data: "暂无数据",
      workspace_required: {
        title: "需要工作区",
        description: "请提供工作区标识。您可以从工作区分析页面访问此页面，或在 URL 中添加 ?workspace_slug=your-workspace-slug。",
      },
    },
    date_range: {
      start_date: "开始日期",
