export default {
  ...
  analytics: {
    user_work_stats: {
      title: "人員工作統計",
      description: "查看團隊成員工作表現的全面統計和洞察。",
      overview: {
        total_assigned: "總分配數",
        total_assigned_description: "分配給團隊成員的工作項總數",
        total_completed: "總完成數",
        total_completed_description: "團隊成員完成的工作項總數",
        completion_rate: "完成率",
        completion_rate_description: "已完成的工作項占分配工作項的百分比",
        avg_completion_time: "平均完成時間",
        avg_completion_time_description: "完成工作項所需的平均時間（天數）",
        overdue_count: "逾期",
        overdue_count_description: "超過目標日期的工作項數量",
      },
      distribution: {
        by_state: "按狀態分布",
        by_priority: "按優先級分布",
      ...
      activity_trends: {
        ...
        created: "已創建",
        completed: "已完成",
        no_data_title: "暫無活動數據",
        no_data_subtitle: "隨時間創建和完成的工作項將顯示在這裡",
      },
      efficiency: {
        title: "成員效率",
        user: "用戶",
      ...
      error: {
        title: "載入統計信息時出錯",
        description: "載入人員工作統計信息時出錯。請稍後重試。",
      },
      no_data: "暫無數據",
      workspace_required: {
        title: "需要工作區",
        description: "請提供工作區標識。您可以從工作區分析頁面訪問此頁面，或在 URL 中添加 ?workspace_slug=your-workspace-slug。",
      },
    },
    common: {
      count: "數量",
